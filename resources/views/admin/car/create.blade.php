...
@include('admin.layouts.common.sidebar')
    ...
    <div class="main-panel">
		<div class="content-wrapper">
            ...
            <div class="card">
              	<div class="card-body">
                <mark class="bg-warning text-white">Car Add Form</mark>
                <form class="form-sample" method="POST" action="{{route('cars.store')}}" enctype="multipart/form-data">
                	{{csrf_field()}}
                  <p class="text-success">Provide Car infomation </p>
                  <div class="row">
	                    <div class="col-md-6 ">
	                        ...
	                        <div class="col-sm-9">
	                          <select class="form-control" name="car_brand">
	                          	...
	                          	@foreach(['MARUTI'=>'MARUTI','MAHINDRA'=>'MAHINDRA','BMW'=>'BMW','TATA'=>'TATA','TOYOTA'=>'TOYOTA'] as $key=>$val)
	                          		<option value="{{$key}}" {{old('car_brand') == $key? "selected":""}}>{{$val}}</option>
	                          	@endforeach	                           
	                          </select>
	                    ...
	                    <div class="col-md-6">
	                      <div class="form-group row{{ $errors->has('car_name') ? ' has-error' : '' }}">
	                        ...
	                        <div class="col-sm-9">
	                          <input class="form-control" placeholder="Car Name" name="car_name" value="{{ old('car_name') }}">
                  	...
                  	<div class="row">
	                    ...
	                    <div class="col-md-6">
	                      <div class="form-group row {{ $errors->has('car_price') ? ' has-error' : '' }}">
	                        ...
	                        <div class="col-sm-9">
	                          <input type="text" class="form-control"  name="car_price" placeholder="Car Price" value="{{ old('car_price') }}">
                  	...
                  	<div class="row">
                  		<div class="col-md-5 pull-right">
                  			<img src="{{URL('assets/profile/no-image.png')}}" alt="demo" id="demoCarImg" >
                  		</div>
                  		<div class="col-md-7 pull-right">
                  			<input type="submit" class="btn btn-outline-success btn-lg" name="submit" value="Save Car">
                  		</div>
                  	</div>                  	
                </form>
              	</div>
